...
<div class="pagemain">
       <div class="homelist" >
            <ul class="clist" style="text-align:center">
                ...
                <li><a href="/index.php/index/kjdata?t=18">重庆幸运农场</a></li>
  ...
  <div class="display biao-cont">
     <table class="table_b">
        <thead>
			...
			<?php
			$sql="select type, time, number, data from ssc_data where type={$_GET['t']}";
			$sql=$sql." order by number desc  limit 50";
			$data=$this->getPage($sql, $this->page, $this->pageSize);
			$typename=$this->getValue("select title from ssc_type where id=?",$_GET['t']);
