		      ...
		      <div class="bgwhite mar15">
				...
				<div class="login-box">
                 <div class="login-input yzm">
					...
					<img style="cursor:pointer;" src="/user/vcode/<?=$this->time?>" class="ml10" title="看不清楚，换一张图片" onclick="this.src='/user/vcode/'+(new Date()).getTime()" align="absmiddle" border="0" height="24" width="82">
                  </div>
                </div>
           </div>
