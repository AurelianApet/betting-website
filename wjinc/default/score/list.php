        ...
        <div class="information_area">
          <div class="information_area_wrap">
            ...
            <div class="tipinfo clearfix">
			  ...
			  <div class="t_open" style="float:left;margin-bottom:10px; color:#810104"><?=$this->getValue("select count(distinct uid) from {$this->prename}score_swap where goodId=?", $var['id'])?>&nbsp;&nbsp;人已参与活动</div>
