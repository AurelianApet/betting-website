...
create procedure setCoin(_coin float, _fcoin float, _uid int, _liqType int, _type int, _info varchar(255) character set utf8, _extfield0 int, _extfield1 varchar(255) character set utf8, _extfield2 varchar(255) character set utf8) begin
	...
	IF  _count<1 THEN
		SELECT coin INTO coin1 FROM ssc_members WHERE `uid`=_uid;
		SELECT fcoin INTO fcoin1 FROM ssc_members WHERE `uid`=_uid;
		SET coin1 = coin1 + _coin;
		SET fcoin1 = fcoin1 + _fcoin;
		UPDATE ssc_members SET coin = coin1, fcoin = fcoin1 WHERE `uid` = _uid;
...
begin
	...
	select b.`uid`, u.parentId, u.username, b.actionNum, b.serializeId, b.actionData, b.actionNo, b.`type`, b.playedId, b.isDelete, b.fanDian, u.fanDian, b.`mode`, b.beiShu, b.zhuiHao, b.zhuiHaoMode, b.bonusProp, b.actionNum*b.`mode`*b.beiShu amount from ssc_bets b, ssc_members u where b.`uid`=u.`uid` and b.id=_betId;
...
on schedule every 1 DAY starts '2014-11-29 23:56:00'
